...
async function cfgTabSistema(){
  ...
  body.innerHTML = `
    ...
    <div class="card"><div class="hd"><i class="ti ti-brand-windows"></i>Instalar no Windows</div><div class="bd">
      <div style="font-size:12.5px;line-height:1.8;color:var(--text2)">
        Do jeito que você usa hoje — abrindo o arquivo — está tudo funcionando, e pode continuar assim para sempre.
        Instalar no Windows é opcional e serve para três comodidades: o sistema ganha <b>ícone na área de trabalho</b> e
        abre em <b>janela própria</b>, sem barra de endereço; os arquivos <b>.jev</b> vindos do celular abrem com dois
        cliques; e as melhorias passam a <b>chegar sozinhas</b>, sem você precisar trocar o arquivo na mão.
      </div>
      <div class="brow" style="margin-top:12px">
        <button class="btn gn" onclick="instalarWindows(this)"><i class="ti ti-download"></i>Baixar o instalador do Windows</button>
        <button class="btn gh" onclick="abrirSistemaNaInternet()"><i class="ti ti-world"></i>Abrir a versão da internet</button>
      </div>
      <div class="al ai" style="margin-top:12px"><i class="ti ti-info-circle"></i><div>
        O instalador tem cerca de <b>75 MB</b> e é baixado do GitHub — precisa de internet. Ao executar, o Windows avisa
        que o programa é de <b>origem desconhecida</b>, porque não tem assinatura digital (é um certificado pago):
        clique em <b>Mais informações</b> e depois em <b>Executar assim mesmo</b>. Ele instala sem pedir senha de
        administrador e <b>não mexe nos seus dados</b>.<br><br>
        Se preferir não baixar nada, o segundo botão abre o sistema num endereço da internet: por lá o próprio navegador
        instala como aplicativo (menu do Chrome → <b>Instalar página como aplicativo</b>), sem download e sem aviso do
        Windows.<br><br>
        Se o download não vier, <b style="color:var(--brand);cursor:pointer;text-decoration:underline" onclick="abrirVersoesJeV()">abra a página das versões</b> e
        baixe por lá o arquivo terminado em <span class="mono">.exe</span>.</div></div>
    </div></div>
    ...
    <div class="card"><div class="hd"><i class="ti ti-info-circle"></i>Sobre o sistema</div><div class="bd">
      ...
      <div class="brow" style="margin-top:12px">
        <button class="btn gh" onclick="go('ver')"><i class="ti ti-refresh-dot"></i>Atualizações e versões</button></div>
    </div></div>`;
}
