...
(async function init(){
  try{
    ...
    /* o relógio das ofertas: só liga se o dono já ligou a chave. Fica de fora
       do try de cima? Não — mas cada peça dele é blindada, e o relógio não
       pode ser o motivo de o sistema não abrir. */
    try { if(typeof ofRelogio==='function' && ofCfg().ligado) ofRelogio(); }
    catch(e){ console.error('ofertas:',e); }
