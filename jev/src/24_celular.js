...
function celLigarDesktop(){
  ...
  /* o dono clicou no aviso da oferta lá na bandeja do Windows */
  if(typeof window.JeVDesktop.aoClicarOferta === 'function')
    window.JeVDesktop.aoClicarOferta(()=>{ if(typeof ofAbrirAgora==='function') ofAbrirAgora(); });
