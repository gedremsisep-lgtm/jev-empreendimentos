...
cat src/01_head.html src/02_body.html \
    ...
    src/24_celular.js src/25_nuvem.js src/26_versao.js src/27_afiliados.js src/28_garimpo.js src/29_anuncio.js src/30_disparo.js src/31_postar.js src/32_cortes.js src/33_afiliado.js src/34_estudio.js src/35_pauta.js src/36_kalo.js src/37_pessoa.js src/24_boot.js src/25_foot.html > jev_empreendimentos.html
python3 embed.py
